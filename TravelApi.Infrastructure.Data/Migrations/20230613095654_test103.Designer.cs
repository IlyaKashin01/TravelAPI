...
namespace TravelApi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20230613095654_test103")]
    partial class test103
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelApi.Domain.Core.Entities.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TravelApi.Domain.Core.Entities.PersonFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("person_file", (string)null);
                });
            ...
            modelBuilder.Entity("TravelApi.Domain.Core.Entities.Person", b =>
                {
                    b.HasOne("TravelApi.Domain.Core.Entities.Car", "Car")
                        .WithMany("Persons")
                        .HasForeignKey("CarId");
